...
const pageSize = 20
const baseUrl = "http://newsapi.org/v2/top-headlines?country=tr&category=technology&pageSize=" + pageSize;
...
newsRouter.get('', async(req, res) => {
    try {
        ...
        if (err.response) {
            res.render('technology', { articles: null })
            ...
            res.render('technology', { articles: null })
            console.error('technology', err.message)
        }
    }
})
